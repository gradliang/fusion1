...
//#define PRODUCT_ID									(PCBA_MAIN_BOARD_V11|PANEL_800x480|UI_WELDING)
...
#define GPIO_SIMPLE_KEY_ENABE							ENABLE
#define  SENSOR_TYPE_NT99140              			ENABLE
#elif  (PRODUCT_UI==UI_WELDING)
#define USBCAM_IN_ENABLE									1// // 1->normal jpg+yuy2  2->only yuy2 640*480
#define  SENSOR_TYPE_NT99140              			ENABLE
#define  TSPI_ENBALE              								ENABLE
#else
#error "\n!!!Please define AV INPUT MODE!!!\n"
#endif
...
// Touch controller
//------------------------------------------------------------------
#define TOUCH_CONTROLLER_ENABLE         DISABLE//ENABLE

  #define TOUCH_CONTROLLER            TOUCH_PANEL_DRIVER_FT5306
  #define TOUCH_CONTROLLER_TYPE       TOUCH_PANEL_TYPE_CAPACITIVE
  #define TOUCH_CONTROLLER_INT_PIN    GPIO_02
  #define TOUCH_RESET_PIN		GPIO_FGPIO_20
...
#define OSD_NEW_WHITE            			2
#define OSD_NEW_RED            				3
#define OSD_NEW_GREEN            			4

#define OSD_BLEND_MAX           0x6  // 0->15
#endif
...
#define ONLY_USE_IPW2						 		ENABLE//Fast input mode
