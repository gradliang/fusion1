...
#define Dialog_EditValue                    12          // 输入
#define Dialog_Value                        13          // 值显示
#define Dialog_About                        14          // 关于本机
#define Dialog_Times                        15          // 电极棒信息
#define Dialog_TempInfo                     16          // 温度信息
#define Dialog_BatInfo                      17          // 电池信息
