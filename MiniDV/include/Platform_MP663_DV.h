...
//#define STD_BOARD_VER           MP663_128BGA_16M_SDRAM
#define STD_BOARD_VER           MP663_144BGA_32M_SDRAM          // Chip Version B

// I80 128x128
//#define TCON_ID                 TCON_I80Mode_128x128
//#define PANEL_ID                PANEL_ILI9163C

// SerialRGB 480x240
//#define TCON_ID                 TCON_RGB8SerialMode_480x240
//#define PANEL_ID                PANEL_OTA5182A

// SerialRGB_ILI 320x240
//#define TCON_ID                 TCON_RGB8SerialMode_320x240_ILI9342
//#define PANEL_ID                PANEL_ILI9342

// SerialRGB_AUO 320x240
...
#define	PRODUCT_FW_VERSION      "MP663_Mini-DV "
...
#define BOOTUP_TYPE             BOOTUP_TYPE_NAND  //default
...
#define SPI_RESERVED_SIZE       0x00100000              // reserved 1MB size for AP code and resource. This value should be 65536 mutiples.
...
#define SPI_RESOCE_SADDR        0x000D0000              // reserved 768KB for AP code , 192KB for resource. This value should be 65536 mutiples
#elif (BOOTUP_TYPE == BOOTUP_TYPE_SD)
#define SYSTEM_DRIVE            SYSTEM_DRIVE_ON_SD
#define SYS_DRV_SIZE            128                     // unit is 256 KB
#define TOOL_DRV_SIZE           8                       // unit is 256 KB  //default
//#define TOOL_DRV_SIZE         0                       // unit is 256 KB
#else
#define SYSTEM_DRIVE            SYSTEM_DRIVE_NONE
#define SYS_DRV_SIZE            0                       // unit is 256 KB
...
#define CARD_PROTECT_FUNC_ENABLE    1                   // 0: For embedded MicroSD case, no write protect function, 1: For normal SD
...
#define XPG_BUF_SIZE                ((160+100) * 1024)
...
// -------------------------------------------------
#define AUDIO_ON					1
#define AUDIO_DAC                   DAC_ES7240//DAC_WM8904//DAC_WM8960
...
//#define SENSOR_TYPE_OV5642          ENABLE
//#define SENSOR_TYPE_OV2643          ENABLE
#define  SENSOR_TYPE_OV2643_JH43A              ENABLE
//#define SENSOR_TYPE_S5K6AAFX13
//#define SENSOR_TYPE_MAGIC_SENSOR

#if (TCON_ID != TCON_NONE)
#define	SENSOR_WITH_DISPLAY         ENABLE
#define USE_IPW1_DISPLAY_MOTHOD     DISABLE

#endif

/*if SENSOR_TO_FB_RGB888_TYPE = ENABLE,
USE_IPW1_DISPLAY_MOTHOD needs to ENABLE first.*/
#define SENSOR_TO_FB_RGB888_TYPE  DISABLE



#if (STD_BOARD_VER == MP663_128BGA_16M_SDRAM)
#define SENSOR_GPIO_SSEN            (VGPIO | GPIO_16)
...
// ui & gpio
// -------------------------------------------------
#define ENABLE_SLIDESHOW_FUNCTION   0
...
//                  MINIDV / minidv
// -------------------------------------------------
#define MINIDV ENABLE
#define SPYC DISABLE
#define CyclicRecording ENABLE
#define LowBattery ENABLE
#define FILE_SHOWPHOTO DISABLE
#define MOTION_DETECT DISABLE
#define ENTERPOWERDOWN ENABLE
#define AUTO_RECORDING DISABLE
#define AUTORECORDBYUSER ENABLE
#define ADC_KEYPAD_HIGH DISABLE
#define KEYPADHALT ENABLE
#define AUTORECORDNOOVERNIGHT ENABLE
#define KEYPADPRINT ENABLE
#define AMR_RECORDING ENABLE
// -------------------------------------------------
...
#define GP_PRODUCT_ID               "Mini DV         "  // 16 letters
...
#define XPG_USE_YUV444              0  // Must JPEG444_NEED_EXTRA_MEM = 1, JPEG444_TO_JPEG444 = 1 and USE_YUV444_FLOW = 0
#define XPG_MULTI_SEARCH            1  // When [EXIT] from page "Card", if true, then show multi .XPG to select

#define XPG_WITH_CARDPAGE           0
