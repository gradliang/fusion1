...
#define STD_BOARD_VER           MP652_216LQFP_32M_DDR // MP652_216LQFP_2LAYER , MP652_216LQFP_4LAYER
#if (STD_BOARD_VER == MP652_216LQFP_2LAYER)
#define IDU_CLKINVT           1  // 2-layer PCB need set to 1
#endif
...
// Internal TCON - 800x480
//#define TCON_ID                 TCON_INTERNAL_800x480
//#define PANEL_ID                PANEL_AT080TN03
// Innolux 8" 800x600
//#define TCON_ID                 TCON_INTERNAL_800x600
//#define PANEL_ID                PANEL_A080SN01
// YPbPr - 1280x720
//#define TCON_ID                 TCON_ITU709Mode_1280x720
//#define PANEL_ID                PANEL_ADV7393

#define	PRODUCT_FW_VERSION      "MP652 STD_DPF"
#define	PRODUCT_MODEL           "Demo" // ¤½ªO
#define	SVN_VERSION             "10593" 
...
#define NAND_RESERVED_SIZE      (24 * 1024 * 1024)      // reserved 16MB for raw data type (ex: ISP)
...
#if Make_ADHOC
#define ADHOC_TEST                /* to disable, use #undef ADHOC_TEST */
#endif
...
#define HAVE_SHOUTCAST          /* to disable, use #undef HAVE_SHOUTCAST */
#define HAVE_FLICKR	1
#define HAVE_PICASA             /* to disable, use #undef HAVE_PICASA */
#define HAVE_GCE 0
#define NET_UPNP 1
...
#if Make_OSIP
#define VIPHONE_ENABLED        1
#define VIPHONE_TEST        1
#else
#undef VIPHONE_ENABLED
#endif
...
#define LCD_BRIGHTNESS_HW1          1   //Brightness control by PWM
...
// PWM-375KHz@50
#define INTERNAL_DTD                DISABLE     //Disable internal DC2DC for panel
#define BRIGHTNESS_CTRL             LCD_BRIGHTNESS_HW1 // PWM enable
#endif
...
#elif (STD_BOARD_VER == MP652_216LQFP_4LAYER)  
#define AUDIO_DAC                   DAC_INTERNAL    
#else    
#define AUDIO_DAC                   DAC_WM8961//DAC_MP702 //DAC_INTERNAL
#endif
...
#define REMOTE_CONTRLLER            REMOTE_DPF_21KEYS
#else
...
#if (STD_BOARD_VER == MP652_216LQFP_2LAYER)
#define GPIO_AMPMUTE                (VGPIO | GPIO_28)
#else
...
#if (STD_BOARD_VER == MP652_216LQFP_4LAYER)
#define USE_GPIO_KEY               1
#else
#define USE_GPIO_KEY               0
#endif
...
#define USBOTG_DEVICE_EXTERN            DISABLE  // ENABLE   // MPX Side Monitor
...
#define THUMB_COUNT                 32 //6 // to fix Bugzilla 86
#define THUMB_WIDTH                 90 //232
#define THUMB_HEIGHT                90 //188
...
//#define SEARCH_TYPE     LOCAL_RECURSIVE_SEARCH      /* scan all, include sub-directories */ 
...
//------------------------------
#define MYFAVOR_PHOTO   0
#define WEEK_PHOTO      0
#define CALENDAR_WHITE  0
#define CALENDAR_BLACK  0
#define DIGIT_CLOCK     0
#define IMAGE_PROCESSING   0

#define FILENAME_BIG5   0
#define FILENAME_GB     0  
//------------------------------
