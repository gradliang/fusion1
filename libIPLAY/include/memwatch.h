...
//define mpx memory function
#define mem_malloc(n)			mwMalloc(n,__FILE__,__LINE__)
#define mem_reallocm(p,n)		mwRealloc(p,n,__FILE__,__LINE__)
#define mem_free(p)				mwFree(p,__FILE__,__LINE__)
//#define	ext_mem_malloc(n)		mwMalloc(n,__FILE__,__LINE__)
//#define	ext_mem_reallocm(p,n)	mwRealloc(p,n,__FILE__,__LINE__)
//#define	ext_mem_free(p)			mwFree(p,__FILE__,__LINE__)
