...
#define _RTL871X_IOCTL_SET_C_		/* added billwang for PLATFORM_MPIXEL */
...
_func_enter_;
	...
	RT_TRACE(_module_rtl871x_ioctl_set_c_,_drv_info_,("set_802_11_auth.mode(): mode=%x ; fw_state = 0x%x\n", authmode, get_fwstate(&padapter->mlmepriv)));
