...
#include <asm/byteorder.h>		//change to use linuxe function
#else
...
static s32 update_txdesc(struct xmit_frame *pxmitframe, u8 *pmem, s32 sz)
{
	...
	{
		//DBG_8192C("pxmitframe->frame_tag = MGNT_FRAMETAG(%x%s)\n", pHalData->CurAntenna, (pHalData->CurAntenna == Antenna_A)?"Antenna_A":"Antenna_B");	
