...
_func_enter_;		
	...
	*(u16*)ie |= cpu_to_le16(cap_IBSS);
	...
	__le32 val = cpu_to_le32(pdev_network->Configuration.DSConfig);
	ie = rtw_set_ie(ie, _DSSET_IE_, 1, (u8 *)&val, &sz);
#else
...
#ifdef PLATFORM_MPIXEL
	/* handle big endian cpu */
	val = cpu_to_le32(pdev_network->Configuration.ATIMWindow);
	ie = rtw_set_ie(ie, _IBSS_PARA_IE_, 2, (u8 *)&val, &sz);
#else
