...
#ifdef PLATFORM_MPIXEL		//change to use linux function
#include <linux/ip.h>		
...
int	rtl8192cu_init_recv_priv(_adapter *padapter)
{
	...
	_rtw_init_sema(&precvpriv->recv_sema, 0, 0);//will be removed
	_rtw_init_sema(&precvpriv->terminate_recvthread_sema, 0, 0);//will be removed
#endif
