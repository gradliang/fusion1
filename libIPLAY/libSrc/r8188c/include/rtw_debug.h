...
#elif defined _RTW_MLME_C_                      /* for PLATFORM_MPIXEL */
	#define	_MODULE_DEFINE_	_module_rtl871x_mlme_c_
#elif defined _RTW_MLME_EXT_C_                  /* for PLATFORM_MPIXEL */
	#define	_MODULE_DEFINE_	_module_mlme_osdep_c_
#elif defined _RTW_XMIT_C_                      /* for PLATFORM_MPIXEL */
	#define	_MODULE_DEFINE_	_module_rtl8192c_xmit_c_
#elif defined _RTW_RECV_OSDEP_C_                /* for PLATFORM_MPIXEL */
	#define _MODULE_DEFINE_	_module_recv_osdep_c_
#endif
...
#undef	_dbgdump
	...
	#elif defined PLATFORM_LINUX
		#define _dbgdump	printk
	#elif defined PLATFORM_MPIXEL		//added for DBG_8192C, WRN_8192C, ERR_8192C
		#define _dbgdump	printk
	#endif
#endif
...
//#ifdef PLATFORM_LINUX		//mark by Joyce, for temp
	#define DBG_871X(x, ...) {}
	#define MSG_8192C(x, ...) {}
	#define DBG_8192C(x,...)  {}
	#define WRN_8192C(x,...)  {}
