...
#undef CONFIG_BT_COEXISTENCE
#undef CONFIG_RTL8192CU_REDEFINE_1X1
...
#undef CONFIG_HW_ANTENNA_DIVERSITY
...
#if 0	//mark by Joyce, don't define
...
//#define CONFIG_P2P	1		//mark by Joyce
#undef CONFIG_P2P			//add by Joyce
