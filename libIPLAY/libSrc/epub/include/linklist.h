...
/*                                                                             
  ...
  are:                                                                         
        ...
        List Transversal  - NextNode1(), PrevNode(), IndexNode()                
...
#define malloc		ext_mem_malloc 
#define realloc  	ext_mem_reallocm
#define free  		ext_mem_free
