...
#define LIBAV_CONFIGURATION "--disable-yasm --disable-avdevice --disable-swscale --disable-avfilter --disable-avresample --disable-encoder=aac --disable-encoder=ac3 --disable-decoders --disable-hwaccels --disable-muxers --disable-outdevs --disable-filters"
#define LIBAV_LICENSE "LGPL version 2.1 or later"
#define AVCONV_DATADIR "/usr/local/share/avconv"
#define CC_IDENT "gcc 4.4.3 (Ubuntu 4.4.3-4ubuntu5)"
#ifdef LINUX
...
//#define assert(cond)    MP_ASSERT(cond)
