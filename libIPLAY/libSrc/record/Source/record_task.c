...
{   	
	...
	case AudioRecording_state:
	mpDebugPrint("/       state= AudioRecording_state 	      /");
	break;

	case AudioRecording_stop_state:
	mpDebugPrint("/       state= AudioRecording_stop_state 	      /");
	break;
...
void PreviewRecStateTaskInit(void)
{
