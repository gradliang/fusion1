...
#if ZDCONF_WPS_SUPPORT == 1 && ZDCONF_AP_SUPPORT == 1
    U8      buffer[160+256/*IEEE80211_MAX_WSC_IE*/];            //use mbuf to send boradcast
#else
