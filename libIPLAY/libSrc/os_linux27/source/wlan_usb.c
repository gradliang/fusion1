                                    ...
                                    WHICH_OTG eWhichOtg)
{
    ...
    if (spTempqHD->head == NULL)
    {
        ...
        qtd = (struct ehci_qtd *)spOldDumyqTD;
    }
#endif
                                                   ...
                                                   WHICH_OTG eWhichOtg)
{
   ...
   ((struct ehci_qtd *)spTempqTD)->urb = psUsbhDevDesc->urb;
    ...
    else
    {
		...
		MP_ASSERT(bArrayListNum < 2);
#else
		MP_ASSERT(bArrayListNum == 0);
#endif
    ...
    if (g_urb == ((struct ehci_qtd *)spTempqTD)->urb)
            BREAK_POINT();
#endif
...
PST_USBH_DEVICE_DESCRIPTOR g_pUsbhDevDes;
//====================================================================
...
// * OutPut: 
//====================================================================
qTD_Structure *  Wlan_flib_Host20_Issue_Interrupt_Active (  BYTE    bArrayListNum,
                                            WORD    hwSize,
                                            DWORD   *pwBufferArray,
                                            DWORD   wOffset,
                                            BYTE    bDirection,
