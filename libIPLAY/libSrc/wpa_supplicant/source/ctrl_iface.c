					     ...
					     size_t buflen)
{
	...
	mpDebugPrint("MATT &&&&& wpa_supplicant_ctrl_iface_wps_pin");
	...
	struct wpa_supplicant *wpa_s, char *cmd)
{
	...
	mpDebugPrint("wpa_supplicant_ctrl_iface_select_network");
	...
	struct wpa_supplicant *wpa_s, char *cmd)
{
	int id;
	struct wpa_ssid *ssid;
	mpDebugPrint("wpa_supplicant_ctrl_iface_enable_network");
	...
	mpDebugPrint("wpa_s->current_ssid %s",wpa_s->current_ssid);
	mpDebugPrint("ssid->disabled %x",ssid->disabled);
#if DEMO_PID
	...
	struct wpa_supplicant *wpa_s, char *cmd)
{
	...
	mpDebugPrint("wpa_supplicant_ctrl_iface_remove_network");
...
#ifdef LINUX
	int ret;
	mpDebugPrint("wpa_supplicant_ctrl_iface_save_config");
					 ...
					 char *buf, size_t *resp_len)
{
	...
	mpDebugPrint("wpa_supplicant_ctrl_iface_process %s",buf);
