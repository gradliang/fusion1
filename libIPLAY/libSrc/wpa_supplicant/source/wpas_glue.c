...
{
 mpDebugPrint("wpa_supplicant_set_config_blob");
#ifdef LINUX
				     ...
				     size_t len)
{
	...
	{
	  memcpy(dst,config_wlan_network.bssid,ETH_ALEN);
	}
	#endif
...
{
    mpDebugPrint("_wpa_supplicant_deauthenticate");
...
{
#ifndef CONFIG_NO_WPA
	mpDebugPrint("wpa_supplicant_init_wpa");
