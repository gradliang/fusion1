...
void *wpa_ctrl_init(void)
{
	ctrl_conn = wpa_ctrl_open("wlan0");
...
#ifndef LINUX
					if (res == 0)			/* select times out */
						goto read_reply;	/* WPA Supplicant task has higer priority. 
											   'set_network psk' takes more than 2 seconds */
#endif
			return -2;
		}
#if DEMO_PID
