...
int mp_HwKeyInstalled(char *addr);
...
#ifdef PLATFORM_MPIXEL
	info->flags |= IEEE80211_TX_SW_ENCRYPTED;
#endif
	return 0;
}
...
static int ccmp_encrypt_skb(struct ieee80211_tx_data *tx, struct sk_buff *skb)
{
	...
	return 0;
#else
	return -1; /* we don't support SW CCMP encrypt */
#endif
}
...
#else
		return RX_DROP_UNUSABLE; /* we don't support SW CCMP decrypt */
#endif
	}
