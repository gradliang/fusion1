...
#define realloc(a,b)	mem_reallocm(a,b)
...
#define sread(x,y,z) mpx_SockRead(x, y, z)
  /* */
#endif
#endif /* HAVE_RECV */
...
#define swrite(x,y,z) mpx_SockWrite(x, y, z)
  /* */
#endif
#endif /* HAVE_SEND */
...
//yuming, add
#define NETCURLDEBUG 0
#define CURLPRINTF(msg...) {if(NETCURLDEBUG)DPrintf(msg);}
...
#else
#define SOCKERRNO         getErrno()
#define SET_SOCKERRNO(x)  setErrno(x)
#endif
#endif
