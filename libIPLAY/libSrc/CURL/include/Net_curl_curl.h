...
typedef int (*curl_progress_callback)(void *clientp,
                                      ...
                                      double ulnow);
#else
/* uItron doesn't support double integer */
typedef int (*curl_progress_callback)(void *clientp,
                                      long dltotal,
                                      long dlnow,
                                      long ultotal,
...
#if 0
  CINIT(X_GCE_SCREEN_SIZE, LONG, 159),
  CINIT(X_GCE_BUTTONS, LONG, 160),
  CINIT(X_GCE_DEVICE_ID, LONG, 161),
  CINIT(X_GCE_DEVICE_NICKNAME, LONG, 162),
#endif
...
#include "net_curl_easy.h" /* nothing in curl is fun without the easy stuff */
#include "net_curl_multi.h"
