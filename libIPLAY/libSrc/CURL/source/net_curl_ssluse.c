...
#include "net_curl_formdata.h" /* for the boundary function */
#include "net_curl_url.h" /* for the ssl config check function */
#include "net_curl_inet_pton.h"
#include "net_curl_ssluse.h"
...
//yuming, add
//#include "memory.h"
#include "net_curl_easyif.h" /* for Curl_convert_from_utf8 prototype */
...
int Curl_ossl_init(void)
{
  ...
  if (!SSLeay_add_ssl_algorithms())
	...
	OPENSSLPRINTF("Curl_ossl_init END");
  return 1;
}
                        ...
                        int sockindex)
{
  ...
  struct ssl_connect_data *connssl = &conn->ssl[sockindex];
	...
	MP_DEBUG("Curl_ossl_connect_step1");
	//__asm("break 100");
  ...
  case CURL_SSLVERSION_DEFAULT:
	...
	infof(data,"SSLv23_client_method");
  ...
  case CURL_SSLVERSION_SSLv2:
  	infof(data,"SSLv2_client_method");
                         ...
                         bool *done)
{
  ...
  long timeout_ms;
	...
	CURLPRINTF("Curl_ossl_connect_common");
	CURLPRINTF("sockfd = %d", sockfd);
