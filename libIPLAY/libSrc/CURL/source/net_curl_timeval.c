...
//yuming, no need to have this function
#if 0
static int gettimeofday(struct timeval *tp, void *nothing)
{
...
{
  struct timeval now;
  //yuming, change timer driver
#if 0
  (void)gettimeofday(&now, NULL);
#else
  unsigned long tick = mpx_SystemTickerGet();
  unsigned long ms = (tick* (1000/HZ));          /* in milliseconds */
 ...
 */
long curlx_tvdiff_secs(struct timeval newer, struct timeval older)
{
