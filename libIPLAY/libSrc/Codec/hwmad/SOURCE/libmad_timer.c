...
unsigned long mad_timer_fraction(mad_timer_t timer, unsigned long denom)
{
	...
	{
	case 0:
		return timer.fraction ? MAD_TIMER_RESOLUTION / timer.fraction : MAD_TIMER_RESOLUTION + 1;
					  ...
					  enum mad_units fracunits, unsigned long subparts)
{
	...
	case MAD_UNITS_HOURS:
		...
		mp_sprintf(dest, format,
				hours, (unsigned int) (minutes % 60), (unsigned int) (seconds % 60), frac, sub);
		break;

	case MAD_UNITS_MINUTES:
		minutes = seconds / 60;

		mp_sprintf(dest, format, minutes, (unsigned int) (seconds % 60), frac, sub);
		break;

	case MAD_UNITS_SECONDS:
		mp_sprintf(dest, format, seconds, frac, sub);
		break;
	...
	case MAD_UNITS_60_FPS:
	case MAD_UNITS_75_FPS:
		mp_sprintf(dest, format, mad_timer_count(timer, units), sub);
		break;
	}
}
