...
void MagicPixel_AMRENC_SRAM_Init(char *start, int size);
...
//void MagicPixel_AMRDEC_decode(Word16 toc,UWord8*packed_bits,Word16 **synth);
void MagicPixel_AMRDEC_decode(Word16 toc,UWord8*packed_bits,Word16 *synth_buf);
int MagicPixel_AMR_resync(DWORD sec);
