...
{
    __sensor_nt99140_i2c_data_high();       IODelay(WAIT_TIME_IIC_DELAY);
}
static void sensor_nt99140_i2c_data_low(void)
{
    __sensor_nt99140_i2c_data_low();        IODelay(WAIT_TIME_IIC_DELAY);
}
...
static BYTE haveSetted = FALSE;

static void NT99140_Initial_Setting()
{
    if (haveSetted)
        return;
    mpDebugPrint("First time call function %s()", __FUNCTION__);
#if 1//99142
...
sensor_nt99140_setRegister(0x3107, 0x10);
...
sensor_nt99140_setRegister(0x3271, 0x04);
...
sensor_nt99140_setRegister(0x3326, 0x14);
...
sensor_nt99140_setRegister(0x3368, 0x40);
sensor_nt99140_setRegister(0x3369, 0x30);
sensor_nt99140_setRegister(0x336B, 0x20);
sensor_nt99140_setRegister(0x336D, 0x20);
sensor_nt99140_setRegister(0x336E, 0x18);
...
static void NT99140_setVGA_640x480_30FPS(void)
{
    ...
    {
        //[VGA_15_30_Fps]  MCLK_12M  PCLK_64M 
		...
		sensor_nt99140_setRegister(0x32e6, 0x00); 
		sensor_nt99140_setRegister(0x32e7, 0x80); 
		sensor_nt99140_setRegister(0x3028, 0x1f); 
		sensor_nt99140_setRegister(0x3029, 0x02); 
		sensor_nt99140_setRegister(0x302a, 0x00); 
		sensor_nt99140_setRegister(0x3022, 0x24); 
		sensor_nt99140_setRegister(0x3023, 0x24); 
		...
		sensor_nt99140_setRegister(0x300b, 0xcb); 
		sensor_nt99140_setRegister(0x300c, 0x02); 
		sensor_nt99140_setRegister(0x300d, 0xe0); 
		sensor_nt99140_setRegister(0x300e, 0x03); 
		sensor_nt99140_setRegister(0x300f, 0xc0); 
		sensor_nt99140_setRegister(0x3010, 0x02); 
		sensor_nt99140_setRegister(0x3011, 0xd0); 
		...
		sensor_nt99140_setRegister(0x32c2, 0xca); 
		sensor_nt99140_setRegister(0x32c8, 0x5c); 
    ...
    {
        //[VIDEO_VGA_FPS_12.5_TO_15_PCLK_32M]
        ...
        sensor_nt99140_setRegister(0x300b, 0x5f);
        sensor_nt99140_setRegister(0x300c, 0x03);
        sensor_nt99140_setRegister(0x300d, 0x07);
        sensor_nt99140_setRegister(0x300e, 0x03);
        sensor_nt99140_setRegister(0x300f, 0xc0);
        sensor_nt99140_setRegister(0x3010, 0x02);
        sensor_nt99140_setRegister(0x3011, 0xd0);
        ...
        sensor_nt99140_setRegister(0x32c2, 0xa2);
        sensor_nt99140_setRegister(0x32c8, 0x3a);
        sensor_nt99140_setRegister(0x32c9, 0x30);
        sensor_nt99140_setRegister(0x32c4, 0x00);
        sensor_nt99140_setRegister(0x3201, 0x7f);
        sensor_nt99140_setRegister(0x3021, 0x06);
        sensor_nt99140_setRegister(0x3060, 0x01);
...
static void NT99140_set_720x480_30FPS(void)
{
    MP_ALERT("## %s ##", __FUNCTION__);
    MP_ALERT("%s: Not Support!!", __FUNCTION__);
    __asm("break 100");
...
static void NT99140_setXGA_1024x768_30FPS(void)
{
    MP_ALERT("## %s ##", __FUNCTION__);     
    MP_ALERT("%s: Not Support!!", __FUNCTION__);
    __asm("break 100");
...
DWORD NT99140_Sensor_GetAvgLuminance(void)
{
    MP_DEBUG1("## %s ##", __FUNCTION__);        
                                            
    SWORD value=0;
    value = sensor_nt99140_readRegister(0x32BA);
    //mpDebugPrint("NT99140 AvgLum = %d", value);
    return (DWORD)value; ;                     
}
...
void static OV_CaptureKey_720P_1280x720()
{
...
void OV_Capture_KeyStting(BYTE IMGSIZE_ID)//(BYTE IMGSIZE_ID)
{
  ...
  switch(IMGSIZE_ID)
  {
    ...
    case SIZE_720P_1280x720:
        OV_CaptureKey_720P_1280x720();
        break;
...
void NT_Capture_preview(void)
{
    MP_ALERT("## %s ##", __FUNCTION__);     
    NT99140_setVGA_640x480();                    
}

int special_mode1 = 0;     // grad add , special, for speed up CAMERA.

int Sensor_Capture_NT99140(STREAM *fileHandle, BYTE Capture_IMGSIZE_ID)
{
    MP_DEBUG1("## %s ##", __FUNCTION__);        
    ...
    {
        case SIZE_5M_2560x1920:
            MP_ALERT("%s:NT99140 Not Support capture IMGSIZE. ID=%d", __FUNCTION__,Capture_IMGSIZE_ID);
            goto Error;
        ...
        case SIZE_720P_1280x720:
            sensor_IMGSIZE_ID = SIZE_720P_1280x720;
            SensorInputWidth  = 1280;
    ...
    while(1)
    {
        if((ipu->Ipu_reg_100&BIT0)==0)//´_¶¨ÓÐŒ‘ßMÈ¥
            break;
    }
    ...
    /*During capture , NT99140 use the same path*/  
    CaptureCloseDisplay_Flag = 0;/*During capture , NT99140 use the same path. Need to cropping*/
...
void Drive_Sensor_NT99140(void)
{
        ...
        if(sensor_mode==MODE_RECORD)
        {
                ...
                {
                        NT99140_set_720x480_30FPS();
                }else if(sensor_IMGSIZE_ID==SIZE_XGA_1024x768)
                {
                        NT99140_setXGA_1024x768_30FPS();
                }else 
                {//default 720p
                        NT99140_set_720P_1280x720();
                }
