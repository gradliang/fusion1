...
DRV_OBJS += ../include/drivers/driver_wired.o
endif

ifdef CONFIG_DRIVER_MADWIFI
DRV_CFLAGS += -DCONFIG_DRIVER_MADWIFI
DRV_OBJS += ../include/drivers/driver_madwifi.o
CONFIG_WIRELESS_EXTENSION=y
...
DRV_OBJS += $(OBJ)driver_nl80211.o
#DRV_OBJS += $(OBJ)radiotap.o
NEED_SME=y
NEED_AP_MLME=y
NEED_NETLINK=y
NEED_LINUX_IOCTL=y
...
DRV_OBJS += ../include/drivers/driver_bsd.o
CONFIG_L2_FREEBSD=y
CONFIG_DNET_PCAP=y
endif
...
DRV_OBJS += ../include/drivers/driver_test.o
NEED_AP_MLME=y
endif

ifdef CONFIG_DRIVER_NONE
DRV_CFLAGS += -DCONFIG_DRIVER_NONE
DRV_OBJS += ../include/drivers/driver_none.o
endif
...
DRV_AP_OBJS += ../include/drivers/driver_atheros.o
CONFIG_L2_PACKET=linux
NEED_NETLINK=y
NEED_LINUX_IOCTL=y
endif
...
DRV_WPA_OBJS += ../include/drivers/driver_ralink.o
NEED_NETLINK=y
NEED_LINUX_IOCTL=y
endif
...
DRV_WPA_OBJS += ../include/drivers/driver_broadcom.o
endif

ifdef CONFIG_DRIVER_NDIS
DRV_WPA_CFLAGS += -DCONFIG_DRIVER_NDIS
DRV_WPA_OBJS += ../include/drivers/driver_ndis.o
...
ifdef NEED_NETLINK
DRV_OBJS += $(OBJ)netlink.o
endif

ifdef NEED_LINUX_IOCTL
DRV_OBJS += $(OBJ)linux_ioctl.o
endif

ifdef NEED_RFKILL
DRV_OBJS += $(OBJ)rfkill.o 
endif
