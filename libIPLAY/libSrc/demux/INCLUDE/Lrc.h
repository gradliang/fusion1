/********************************************
*
*lyric parsing and showing header file
*create: 2005/10/21
*
********************************************/
#ifndef _LRC_H_
...
typedef struct _LRC_TIMETAG_ {
	int time;
	char* lyric;
	char bfilled;
	char bdisplaying;
}LRC_TIMETAG, *PLRC_TIMETAG;

typedef struct _LRC_LINE_ {
	int seq_num;
	int start_pt;
	int end_pt;
	//char* line_part;
...
typedef void (*Lrc_showproc)(char*);
...
static unsigned short gbk2uni[24192] = { //GBK to UTF16BE table
/* 0x8140 - 0x81FF */
