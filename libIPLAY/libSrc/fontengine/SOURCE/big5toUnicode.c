#include "global612.h"
WORD Big5_to_Unicode_table1[89][63] = 
{
    {   // 0xA140 ~ 0xA17E
...
//----------------------------------------------------------------------------
// Big5_to_Unicode_table2[i][j]
// i: 0xA1 ~ 0xF9
// j: 0xA1 ~ 0xFE
WORD Big5_to_Unicode_table2[89][94] =
{
    {   // 0xA1A1 ~ 0xA1FE
    ...
    {   // 0xA3A1 ~ 0xA3FE
        ...
        0x3128, 0x3129, 0x02D9, 0x02C9, 0x02CA, 0x02C7, 0x02CB, 0xFFFD,
        0xFFFD, 0xFFFD, 0xFFFD, 0xFFFD, 0xFFFD, 0xFFFD, 0xFFFD, 0xFFFD,
        0xFFFD, 0xFFFD, 0xFFFD, 0xFFFD, 0xFFFD, 0xFFFD, 0xFFFD, 0xFFFD,
        0xFFFD, 0xFFFD, 0xFFFD, 0xFFFD, 0xFFFD, 0xFFFD, 0xFFFD, 0xFFFD,
        0xFFFD, 0xFFFD, 0xFFFD, 0xFFFD, 0xFFFD, 0xFFFD, 0xFFFD, 0xFFFD,
    ...
    {   // 0xC7A1 ~ 0xC7FE
        ...
        0x247A, 0x247B, 0x247C, 0x247D, 0xFFFD, 0xFFFD      
    },
    ...
    {   // 0xF9A1 ~ 0xF9FE
        ...
        0x706A, 0x9EA4, 0x9F7E, 0x9F49, 0x9F98, 0xFFFD, 0xFFFD, 0xFFFD,
        0xFFFD, 0xFFFD, 0xFFFD, 0xFFFD, 0xFFFD, 0xFFFD, 0xFFFD, 0xFFFD,
        0xFFFD, 0xFFFD, 0xFFFD, 0xFFFD, 0xFFFD, 0xFFFD, 0xFFFD, 0xFFFD,
        0xFFFD, 0xFFFD, 0xFFFD, 0xFFFD, 0xFFFD, 0xFFFD, 0xFFFD, 0xFFFD,
        0xFFFD, 0xFFFD, 0xFFFD, 0xFFFD, 0xFFFD, 0xFFFD, 0xFFFD, 0xFFFD,
...
WORD Conv_BIG5_to_Unicode( WORD big5code )
{
    BYTE hicode, lowcode;
    WORD * Big5_table;
    ...
    if ( (big5code < 0xA140) || (big5code > 0xF9FE) )
        return 0xFFFD;
    
    hicode = big5code >> 8;
    lowcode = big5code & 0xFF;
    
    if ( (lowcode < 0x40) || (lowcode > 0xFE) )
        return 0xFFFD;
    
    if ( (lowcode > 0x7E) && (lowcode < 0xA1) )
        return 0xFFFD;
    
    hicode -= 0xA1;
    
    if ( lowcode < 0xA1 ) {
        Big5_table = Big5_to_Unicode_table1[hicode];
        lowcode -= 0x40;
    } else {
        Big5_table = Big5_to_Unicode_table2[hicode];
        lowcode -= 0xA1;
    }
    
    return (WORD)Big5_table[lowcode];
}